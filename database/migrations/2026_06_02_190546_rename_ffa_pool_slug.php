...
{
    /**
     * Give the FF&A pool its own slug so it no longer collides with the generic tournament slug
     * 'world-cup-2026' (a second pool — Brothers Association — is now seeded over the same
     * tournament, and pool routes bind {pool:slug}). Renames only the pools row; the tournament
